    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow bg-primary py-0">
            <div class="container">
                ...
                <a href="{{ url('/task') }}" class="btn text-white p-3 nav-list @if (strpos(request()->url(), 'task') !== false) active @endif">Task</a>
                <a href="{{ url('/timesheet') }}" class="btn text-white p-3 nav-list @if (strpos(request()->url(), 'timesheet') !== false) active @endif">Timesheet</a>
                @endguest
        ...
        <main class="py-4 d-flex m-auto container-fluid">
            @yield('content')
        </main>
    </div>
    @yield('script')
